...
class CMenu extends CWidget
{
	 ...
	 * </ul>
	 * @var  array<array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]}>
	 */
    public $items=array();
	/**
	 ...
	 * @param array<array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]}> $items menu items. Each menu item will be an array with at least two elements: 'label' and 'active'.
	 ...
	 * @param array<array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]}> $items the menu items to be rendered recursively
	 */
	 ...
	 * @param array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]} $item the menu item to be rendered. Please see {@link items} on what data might be in the item.
	 * @return string
	 * @since 1.1.6
	 */
	 ...
	 * @param array<array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]}> $items the items to be normalized.
	 ...
	 * @param array{label?:string,encodeLabel?:boolean,url?:string,visible?:boolean,items?:array,active?:boolean,template?:string,linkOptions:?string[],itemOptions?:string[],submenuOptions:string[]} $item the menu item to be checked
	 * @param string $route the route of the current request
